                ...
                <div class="flex-item">
                    ...
                    <sup>
                        ...
                        $archiveFileToolTipTitle = sprintf(
                            __('This link is used in with the <a href=\'%1$s\'>%2$s</a>. %3$s', 'duplicator-pro'),
                            get_admin_url(null, 'admin.php?page=duplicator-pro-import'),
                            __('Import Link Install', 'duplicator-pro'),
                            __('featuer. Use the Copy Link button to copy this URL archive file link to import on another WordPress site.', 'duplicator-pro')
                        );?>
