...
class DUP_PRO_Storage_Entity extends DUP_PRO_JSON_Entity_Base
{
    ...
    */
    public static function getStorageIcon($id)
    {
        $html = '';
        switch ($id) {
            case DUP_PRO_Storage_Types::Local :             $html = '<i class="fas fa-hdd fa-fw"></i>';              break;
            case DUP_PRO_Storage_Types::Dropbox :           $html = '<i class="fab fa-dropbox fa-fw"></i>';            break;
            case DUP_PRO_Storage_Types::FTP :               $html = '<i class="fas fa-network-wired fa-fw"></i>';      break;
            case DUP_PRO_Storage_Types::GDrive :            $html = '<i class="fab fa-google-drive fa-fw"></i>';       break;
            case DUP_PRO_Storage_Types::S3 :                $html = '<i class="fab fa-aws fa-fw"></i>';                break;
            case DUP_PRO_Storage_Types::SFTP :              $html = '<i class="fas fa-network-wired fa-fw"></i>';      break;
            case DUP_PRO_Storage_Types::OneDrive :
            case DUP_PRO_Storage_Types::OneDriveMSGraph :   $html = '<i class="fas fa-cloud fa-fw"></i>';              break;
            default:$html = '<i class="fas fa-cloud fa-fw"></i>'; break;
        }
        return $html;
    }
