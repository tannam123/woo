...
if ($recoveryStatus->getType() == RecoveryStatus::TYPE_SCHEDULE) {
    ...
    $tooltipContent = esc_attr__('A Schedule is not required to have a recovery point. For example if a schedule is backing up '
    ...
    $tooltipContent = esc_attr__('A Template is not required to have a recovery point. For example if backing up only a database '
...
<div class="dup-recover-dlg-title">
    ...
    <?php _e('unavailable', 'duplicator-pro'); ?>
    <sup>
