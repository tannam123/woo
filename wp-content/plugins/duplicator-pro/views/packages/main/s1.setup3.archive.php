...
<div class="dup-box-panel" id="dup-pack-archive-panel" style="<?php echo esc_attr($ui_css_archive); ?>">
    ...
    <div data-dpro-tabs="true">
        <ul>
            ...
            <!-- <li class="filter-db-tab"><?php DUP_PRO_U::esc_html_e('Setup') ?></li>-->
        ...
        <div>
            ...
            <div class="dup-form-item" id="dup-file-filter-label">
                ...
                <span class="input">
                    ...
                    <label for="filter-on"><?php DUP_PRO_U::esc_html_e("Allow folders, files &amp; file extensions to be excluded") ?></label>
