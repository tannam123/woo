...
function vscf_admin_init() {
	...
	add_settings_field( 'vscf-field-24', esc_attr__( 'Sum', 'very-simple-contact-form' ), 'vscf_field_callback_24', 'vscf-general', 'vscf-general-section' );
	register_setting( 'vscf-general-options', 'vscf-setting-24', array('sanitize_callback' => 'sanitize_key') );
	...
	add_settings_field( 'vscf-field-26', esc_attr__( 'Sum error', 'very-simple-contact-form' ), 'vscf_field_callback_26', 'vscf-label', 'vscf-label-section' );
	...
	add_settings_field( 'vscf-field-8', esc_attr__( 'Links error', 'very-simple-contact-form' ), 'vscf_field_callback_8', 'vscf-label', 'vscf-label-section' );
...
function vscf_field_callback_24() {
	...
	<label><input type='checkbox' name='vscf-setting-24' <?php checked( esc_attr($value), 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Disable sum.', 'very-simple-contact-form' ); ?></label>
	<?php
}
...
function vscf_field_callback_25() {
	...
	<?php printf( esc_attr__( 'Default value is %s.', 'very-simple-contact-form' ), __( 'One', 'very-simple-contact-form' ) ); ?>
	<p><i><?php esc_attr_e( 'Allow or disallow links in Message field.', 'very-simple-contact-form' ); ?></i></p>
	<?php
}
...
function vscf_field_callback_4() {
	...
	<label><input type='checkbox' name='vscf-setting-4' <?php checked( esc_attr($value), 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Disable privacy consent checkbox on form.', 'very-simple-contact-form' ); ?></label>
	<?php
}
...
function vscf_field_callback_8() {
	$placeholder = __( 'Please reduce number of links', 'very-simple-contact-form' );
