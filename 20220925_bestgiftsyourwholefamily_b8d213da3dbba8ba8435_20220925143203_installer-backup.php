...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20220925_bestgiftsyourwholefamily_b8d213da3dbba8ba8435_20220925143203_archive.zip';
        const ARCHIVE_SIZE       = '85121137';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'b8d213d-25143203';
        const SECONDARY_PACKAGE_HASH = '0e75efb-25143203';
        const VERSION            = '4.5.0';
